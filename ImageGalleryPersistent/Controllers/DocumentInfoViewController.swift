...
//
//  Created by Evgeniy Ziangirov on 26/08/2018.
...
class DocumentInfoViewController: UIViewController {
    ...
    override func viewDidLayoutSubviews() {
        ...
        if let fittedSize = topLvlView?.sizeThatFits(UIView.layoutFittingCompressedSize) {
    ...
    @IBOutlet weak var topLvlView: UIStackView!
